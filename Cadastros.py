...
meu_nome = 'Alex'
print('Dígite seu NOME ou pule para digitar seu SOBRENOME!')
#sleep(1)
ajuda.lin()
...
seguir = 'Sim'
proximo = 'Não'
hm = input('Você tem hora marcada? ').title()
while hm != 'Sim' and hm != 'Não':
    hm = input('Não entendi poderia repetir? ').title()
else:
    if hm == seguir:
        ...
        #sleep(1)
            ...
            while am_pm != 'AM' and am_pm != 'PM':
                ...
                if am_pm == manhã:
                    print(f'Seu horário é {horário}AM')
                elif am_pm == noite:
...
seguir = 'Sim'
proximo = 'Não'
pergunta_principal = print('\033[1m', 'O seu problema é com algum produto nosso?', '\033[1m')
        ...
        if lista_de_problemas == 0:
            ...
            while p1 != 'Sim' and p1 != 'Não':
                ...
                if p1 == proximo2:
                    ...
                    input(int('Coloque o seu número de telefone: '))
